...
def xs_run_command_and_check(img_file, emu_directory, dest_folder):
    ...
    prev_line = ''
    spec_tag = 0
    recent_lines = []  # Initialize a list to store recent lines
    last_commit_instr = 0 # Determine the termination instruction
    ...
    if spec_tag == 0:
        ...
        if different_count == 1 and check_xor_and_execute(recent_lines) == 1:
            ...
            # Avoid specification errors at the assembly level:
            img_file_name = os.path.basename(img_file)
