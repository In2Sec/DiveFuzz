...
def fliter_known_bug(input_string):
    ...
    bug_flag = '<--'
    bug_number = 0
    bug_1 = 'right= 0x7ff8000000000000' # 64-bit positive infinity
    bug_2 = 'right= 0xffffffff7fc00000'
    bug_3 = 'right= 0xfff0000000000000'
    bug_4 = 'right= 0xffffffffff800000'
    # bug_5 = 'c.addi4spn'
    # bug_6 = 'c.ldsp'
    # bug_7 = 'c.lwsp'
    # bug_set = ['c.lui','c.jr', 'c.addiw', 'c.addi16sp', 'c.addi4spn' ]
    # Check whether any substring exists
