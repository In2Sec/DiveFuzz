...
import sys
import time
from utils.elf_to_img import process_assembly_files_to_timeout, process_file
...
def modify_assembly_code(file_path, new_file_path):
    ...
    for line in lines:
        ...
        if in_mepc_setup and ('slli' in line or 'srli' in line):
            line_index += 1
            continue
...
def process_folders(img_folder):
    ...
    target_folder = os.path.join(img_folder, 'rewrite_to_mepc')
    ...
    process_assembly_files_to_timeout(target_folder)
